    ...
    while has_next_page:
        ...
        for status in statuses['data']:
            ...
            if 'reactions' in status:
                ...
                # status['reactions'] = [
                # {reaction_types[0]:reactions_data[0]},
                # {reaction_types[1]:reactions_data[1]},
                # {reaction_types[2]:reactions_data[2]},
                # {reaction_types[3]:reactions_data[3]},
                # {reaction_types[4]:reactions_data[4]},
                # {reaction_types[5]:reactions_data[5]},
                # ]
